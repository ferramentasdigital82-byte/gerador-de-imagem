...
interface GeminiProChatProps {
  t: (key: string) => string;
}

const GeminiProChat: React.FC<GeminiProChatProps> = ({ t }) => {
    ...
    <>
      <div className="max-w-4xl mx-auto flex flex-col h-[70vh] bg-gray-800 rounded-2xl shadow-lg border border-gray-700">
        <div className="flex justify-between items-center p-4 border-b border-gray-700 flex-shrink-0">
            <h2 className="text-lg font-bold text-gray-200">{t('chat.complexChatTitle')}</h2>
            <button
        ...
        <div className="p-4 border-t border-gray-700 flex-shrink-0">
          <div className="flex items-center space-x-2">
            <textarea
              ...
              placeholder={t('chat.complexPromptPlaceholder')}
