...
const ImageEditing: React.FC<ImageEditingProps> = ({ t }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 bg-gray-800 rounded-2xl shadow-lg border border-gray-700">
      <h2 className="text-2xl font-bold mb-4 text-center text-gray-200">{t('imageEditing.title')}</h2>
      <p className="text-center text-gray-400 mb-6">{t('imageEditing.description')}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col items-center justify-center p-4 bg-gray-700 border-2 border-dashed border-gray-600 rounded-lg">
          {previewUrl ? (
            ...
            <div className="text-center text-gray-400">
              ...
              <p className="mt-2">{t('imageEditing.uploadPlaceholder')}</p>
            </div>
          )}
        ...
        <div className="flex flex-col items-center justify-center p-4 bg-gray-900 border-2 border-dashed border-gray-600 rounded-lg">
          {isLoading ? (
             <div className="w-full h-full flex items-center justify-center animate-pulse text-gray-400">{t('imageEditing.editingButton')}...</div>
          ) : editedImageUrl ? (
            ...
            <div className="text-center text-gray-400">
              ...
              <p className="mt-2">{t('imageEditing.editedPlaceholder')}</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="mt-6 space-y-4">
        <textarea
          ...
          placeholder={t('imageEditing.promptPlaceholder')}
        ...
        >
          {isLoading ? t('imageEditing.editingButton') : t('imageEditing.applyEditButton')}
        </button>
      </div>
